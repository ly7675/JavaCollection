...
public class ThreadPoolUtils {
    ...
    public ThreadPoolUtils(int corePoolSize,
         ...
         * 线程工厂
         */
        CustomThreadFactory threadFactory = new CustomThreadFactory(poolName);
        this.executor = new ThreadPoolExecutor(corePoolSize, maximumPoolSize, 60L, TimeUnit.SECONDS, new ArrayBlockingQueue<>(queueSize), threadFactory, abortPolicy);
    }
